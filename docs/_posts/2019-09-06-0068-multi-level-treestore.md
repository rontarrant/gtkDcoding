...
*Note: The example used herein is based heavily on the D-language `TreeStore` example found on a [Google Sites page](https://sites.google.com/site/gtkdtutorial#chapter6) built back in 2013 (right at the bottom of the page). I could find no credits, so to the anonymous writer of that tutorial, I thank you.*
...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img0" src="/images/screen shots/017_mvc/mvc_017_18.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img1" src="/images/screen shots/017_mvc/mvc_017_18_term.png" alt="Current example terminal output">		<!-- img#, filename -->
...
In the original example, there were two functions for adding locations:
...
Followed which, we populate each hierarchy of continent, country, and city like this:
...
The second overload has three arguments, a `TreeIter` for the parent that’ll “be the boss of” the child we’re creating, a string for the child’s name, and the, of course, a `uint`.

*Note: When doing overloaded functions, make sure the argument lists are different so D knows which instance of the overload you’re calling.*

##The View

The view is no different than what we used in the earlier `TreeStore` example:
...
All this `TreeView`/`TreeStore` stuff is rather easy once we’ve broken it all down. Yes, there’s a lot involved, but none of it’s really a brain bender.
