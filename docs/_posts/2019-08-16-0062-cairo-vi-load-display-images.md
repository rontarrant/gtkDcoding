...
<div class="screenshot-frame">
	...
	<div class="frame-footer">																							<!--------- filename (below) ------------>
		The code file for this example is available <a href="https://github.com/rontarrant/gtkDcoding/blob/master/018_cairo/cairo_018_display_jpeg.d" target="_blank">here</a>.
	</div>
</div>
