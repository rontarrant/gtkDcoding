...
<div class="screenshot-frame">
	...
	<div class="frame-footer">																																<!-- filename (below)-->
		The code file for this example is available <a href="https://github.com/rontarrant/gtkDcoding/blob/master/001_window/window_001_03_sized.d" target="_blank">here</a>.
	</div>
</div>

Cutting straight to the chase, there’s only one new line of code here:
...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img2" src="/images/screenshots/001_window/window_001_04.png" alt="Current example output">							<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img3" src="/images/screenshots/001_window/window_001_04_term.png" alt="Current example terminal output"> 					<!-- img#, filename -->
	...
	<div class="frame-footer">																																<!-- filename (below)-->
		The code file for this example is available <a href="https://github.com/rontarrant/gtkDcoding/blob/master/001_window/window_001_04_other_sized.d" target="_blank">here</a>.
	</div>
</div>
