...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img0" src="/images/screenshots/013_dialogs/dialog_02.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img1" src="/images/screenshots/013_dialogs/dialog_02_term.png" alt="Current example terminal output">		<!-- img#, filename -->
