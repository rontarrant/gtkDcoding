...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img0" src="/images/screenshots/006_text/text_04.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img1" src="/images/screenshots/006_text/text_04_term.png" alt="Current example terminal output">		<!-- img#, filename -->
...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img2" src="/images/screenshots/006_text/text_05.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img3" src="/images/screenshots/006_text/text_05_term.png" alt="Current example terminal output"> 		<!-- img#, filename -->
