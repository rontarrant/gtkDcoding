...
<div class="screenshot-frame">
	...
	<div class="frame-footer">																								<!-- ------------- filename (below) --------- -->
		The code file for this example is available <a href="https://github.com/rontarrant/gtkDcoding/blob/master/bar_03_statusbar.d" target="_blank">here</a>.
	</div>
</div>
...
- filling a `DrawingArea` (from [cairo_01_fill_surface.d](https://github.com/rontarrant/gtkDcoding/blob/master/018_cairo/cairo_01_fill_surface.d)), and
- tracking the mouse (from [mouse_04_tracker.d](https://github.com/rontarrant/gtkDcoding/blob/master/005_mouse/mouse_04_tracker.d)).
...
The call to `addOnMotionNotify()` (borrowed from [the mouse example mentioned above](https://github.com/rontarrant/gtkDcoding/blob/master/005_mouse/mouse_04_tracker.d)) brings a second callback into play:
